...
{  
    ...
    {  
        try
        {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/qa?autoReconnect=true&useSSL=false","qa","anusha@123"); //connecting to database 'qa'
    ...
    void adduserans() //function to connect to qa database and insert user's answers into ua table
    {
        ...
        {
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/qa?autoReconnect=true&useSSL=false","qa","anusha@123");
            Statement stmt = con.createStatement();
            for(int i=0;i<=3;i++)
            {
    ...
    {  
        ...
        {
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/qa?autoReconnect=true&useSSL=false","qa","anusha@123"3);
            Statement stmt = con.createStatement();
            for(int i=1;i<=10;i++)
            {
